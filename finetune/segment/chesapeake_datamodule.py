...
class ChesapeakeDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        label_mapping = {0: 0, 1: 1} # binary
        #label_mapping = {0: 0, 3: 1, 6: 2, 15: 3, 33: 4, 35: 5, 39: 6, 41: 7}
        remapped_label = np.vectorize(label_mapping.get)(label)
        #print(np.unique(remapped_label))
        ...
        sample = {
            ...
            # Remove dimensão extra ao rótulo para que fique [1, H, W] - caso binário
            "label": torch.from_numpy(remapped_label).squeeze(1),
